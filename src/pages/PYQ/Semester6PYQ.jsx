...
const Semester6PYQ = () => {
  ...
  const handleDownload = async (pdfUrl, subjectName) => {
    try {
      ...
      link.href = url;
      link.download = `${subjectName}-Semester6.pdf`;
        ...
        <div className="max-w-7xl w-full px-6">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl font-extrabold text-slate-800 mt-4">
              Semester <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">6</span> PYQs
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-md p-4 flex items-center justify-center gap-3 border border-gray-100">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-slate-800">{semester6pyq.length}</p>
              </div>
            </div>
            <div className="bg-white rounded-2xl shadow-md p-4 flex items-center justify-center gap-3 border border-gray-100">
                ...
                <div className="flex-1 flex flex-col p-5">
                  ...
                  <div>
                    ...
                    <p className="text-center text-gray-800 text-xl mt-2">
                      Semester 6 Previous Year Examination Paper
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2.5 mt-3">
                    <div className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-xl px-2 py-1.5 text-center border border-slate-100">
                      ...
                      <p className="text-xs font-bold text-blue-600 mt-0.5">6</p>
                    </div>
                  ...
                  <div className="flex gap-2 mt-3">
                    ...
                    <button
                      onClick={() => handleDownload(item.pdf, item.subject)}
          ...
          <div className="mt-12 bg-white rounded-3xl shadow-lg p-6 border border-gray-100 max-w-4xl mx-auto">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex gap-3">
                ...
                <button className="px-5 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-xl font-semibold transition-all shadow-lg shadow-purple-200 text-xs">
                  Semester 3
                </button>
                <button className="px-5 py-2 bg-pink-600 hover:bg-pink-700 text-white rounded-xl font-semibold transition-all shadow-lg shadow-pink-200 text-xs">
                  Semester 4
                </button>
                <button className="px-5 py-2 bg-orange-600 hover:bg-orange-700 text-white rounded-xl font-semibold transition-all shadow-lg shadow-orange-200 text-xs">
                  Semester 5
                </button>
              </div>
            </div>
