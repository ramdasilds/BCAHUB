import semester5pyq from "../../data/semester5pyq";
...
const Semester5PYQ = () => {
  ...
  const handleDownload = async (pdfUrl, subjectName) => {
    try {
      ...
      link.href = url;
      link.download = `${subjectName}-Semester5.pdf`;
        ...
        <div className="max-w-7xl w-full px-6">
          ...
          <div className="text-center mb-16">
            ...
            <h1 className="text-5xl font-extrabold text-slate-800 mt-4">
              Semester <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">5</span> PYQs
            </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-md p-4 flex items-center justify-center gap-3 border border-gray-100">
              ...
              <div>
                ...
                <p className="text-xl font-bold text-slate-800">{semester5pyq.length}</p>
              </div>
            </div>
            <div className="bg-white rounded-2xl shadow-md p-4 flex items-center justify-center gap-3 border border-gray-100">
                ...
                <div className="flex-1 flex flex-col p-5">
                  ...
                  <div>
                    ...
                    <p className="text-center text-gray-800 text-xl mt-2">
                      Semester 5 Previous Year Examination Paper
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-2.5 mt-3">
                    <div className="bg-gradient-to-br from-slate-50 to-blue-50 rounded-xl px-2 py-1.5 text-center border border-slate-100">
                      ...
                      <p className="text-xs font-bold text-blue-600 mt-0.5">5</p>
                    </div>
